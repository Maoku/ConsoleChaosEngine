...
import { MASTER_PALETTE_UNIFORM } from './master_palette';
import blocksSource from '../shaders/quantize_fc_blocks.glsl?raw';
import quantizeSource from '../shaders/quantize_fc.glsl?raw';
