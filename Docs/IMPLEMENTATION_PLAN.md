...
- 取り込み時に `Docs/REFERENCE_SNAPSHOT.json` を生成し、基準コミット、相対パス、サイズ、SHA-256 を記録する。
...
| ID | 作業 | 成果物 | 受け入れ条件 |
|---|---|---|---|
| P0-01 | 参照元の SHA と clean 状態を記録 | `REFERENCE_SNAPSHOT.json` | SHA が `6281193`、全対象ファイルに hash がある |
